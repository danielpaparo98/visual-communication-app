<template>
  <header class="editor-topbar h-12 bg-white border-b border-gray-200 flex items-center justify-between px-4 shrink-0">
    ...
    <!-- Right Section: Preview, Print, Export, Settings -->
    <div class="flex items-center gap-2">
      ...
      <button
        @click="handlePrint"
        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors text-gray-600 hover:text-gray-900 text-sm font-medium"
